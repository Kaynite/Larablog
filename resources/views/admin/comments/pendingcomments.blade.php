...
@section('pageTitle', 'Pending Comments')
                    ...
                    <tbody>
                        @if ($comments->count() > 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="label label-success" href="{{ route('adminApproveComment', $comment->id) }}" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="Approve"><i class="feather icon-check"></i></a>
                                    ...
                                    <span data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="Move To Trash">
