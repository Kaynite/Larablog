...
@section('pageTitle', 'Comments Trash')
                    ...
                    <tbody>
                        @if ($comments->count() > 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="label label-success" href="{{ route('adminRestoreComment', $comment->id) }}" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="Restore"><i class="feather icon-refresh-ccw"></i></a>
                                    ...
                                    <span data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="Delete">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a type="button" href="{{ route('adminForceDeleteComment', $comment->id) }}" class="btn btn-danger waves-effect waves-light ">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
